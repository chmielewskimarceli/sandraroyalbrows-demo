...
// System kontroli FPS
let lastTime = 0;
// Telefony: 30 FPS, Desktopy: 60 FPS
...
function animate(currentTime) {
    ...
    // Ogranicznik klatek - omijamy przerysowanie, jeśli nie minął odpowiedni czas
    ...
    for (let line of lines) {
        ...
        // Optymalizacja: Zaokrąglanie wszystkich współrzędnych do 1 miejsca po przecinku
        // To drastycznie przyspiesza parsowanie atrybutu "d" przez przeglądarkę
        const d = `
            M0 ${line.y.toFixed(1)}
...
// Inicjacja animacji ze znacznikiem czasu
